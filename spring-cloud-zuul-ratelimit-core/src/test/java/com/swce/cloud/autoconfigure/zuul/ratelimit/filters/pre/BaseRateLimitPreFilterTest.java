package com.swce.cloud.autoconfigure.zuul.ratelimit.filters.pre;
...
import com.swce.cloud.autoconfigure.zuul.ratelimit.config.properties.RateLimitProperties.Policy;
import com.swce.cloud.autoconfigure.zuul.ratelimit.config.properties.RateLimitProperties.Policy.MatchType;
import com.swce.cloud.autoconfigure.zuul.ratelimit.config.properties.RateLimitType;
import com.swce.cloud.autoconfigure.zuul.ratelimit.filters.RateLimitPreFilter;
import com.swce.cloud.autoconfigure.zuul.ratelimit.filters.commons.TestRouteLocator;

...
import com.marcosbarbero.tests.Bucket4jIgniteApplication;
...
public class Bucket4jIgniteApplicationTestIT {
    ...
    @Test
    public void testBucket4jIgniteRateLimiter() {
        assertTrue("bucket4jIgniteRateLimiter", rateLimiter instanceof Bucket4jIgniteRateLimiter);
    }
    ...
    public void testExceedingCapacity() throws InterruptedException {
        ...
        assertNotEquals(Bucket4jIgniteApplication.ServiceController.RESPONSE_BODY, response.getBody());

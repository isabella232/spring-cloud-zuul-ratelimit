...
image:https://travis-ci.org/SWCE/spring-cloud-zuul-ratelimit.svg?branch=master["Build Status", link="https://travis-ci.org/SWCE/spring-cloud-zuul-ratelimit"] image:https://sonarcloud.io/api/project_badges/measure?project=SWCE_spring-cloud-zuul-ratelimit&metric=alert_status["Quality Gate", link="https://sonarcloud.io/dashboard?id=SWCE_spring-cloud-zuul-ratelimit"] image:https://coveralls.io/repos/github/SWCE/spring-cloud-zuul-ratelimit/badge.svg?branch=master["Coverage Status", link="https://coveralls.io/github/SWCE/spring-cloud-zuul-ratelimit?branch=master"] image:https://api.bintray.com/packages/swce/spring-cloud-zuul-ratelimit/spring-cloud-zuul-ratelimit/images/download.svg[link="https://bintray.com/swce/spring-cloud-zuul-ratelimit/spring-cloud-zuul-ratelimit"]
...
Add the dependency on pom.xml (jcenter)

[source, xml]
----
<dependency>
    <groupId>com.github.swce</groupId>
...
|default-policy-list |List of link:./spring-cloud-zuul-ratelimit-core/src/main/java/com/github/swce/autoconfigure/zuul/ratelimit/config/properties/RateLimitProperties.java#L82[Policy]| -
|policy-list         |Map of Lists of link:./spring-cloud-zuul-ratelimit-core/src/main/java/com/github/swce/autoconfigure/zuul/ratelimit/config/properties/RateLimitProperties.java#L82[Policy]| -
...
be done just by creating a custom link:./spring-cloud-zuul-ratelimit-core/src/main/java/com/github/swce/autoconfigure/zuul/ratelimit/config/RateLimitKeyGenerator.java[`RateLimitKeyGenerator`]
...
link:./spring-cloud-zuul-ratelimit-core/src/main/java/com/github/swce/autoconfigure/zuul/ratelimit/config/repository/DefaultRateLimiterErrorHandler.java[`DefaultRateLimiterErrorHandler`]
...
link:./spring-cloud-zuul-ratelimit-core/src/main/java/com/github/swce/autoconfigure/zuul/ratelimit/config/repository/RateLimiterErrorHandler.java[`RateLimiterErrorHandler`]
bean, e.g:
...
https://github.com/SWCE/spring-cloud-starter-zuul-ratelimit/blob/master/docs/code-of-conduct.adoc[code of conduct].
By participating, you are expected to uphold this code. Please report unacceptable behavior to lchayoun@gmail.com.

=== Acknowledgement

== Footnote
Any doubt open an https://github.com/SWCE/spring-cloud-starter-zuul-ratelimit/issues[issue].
Any fix send me a https://github.com/SWCE/spring-cloud-starter-zuul-ratelimit/pulls[Pull Request].

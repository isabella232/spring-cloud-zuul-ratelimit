= Spring Cloud Zuul RateLimit image:https://travis-ci.org/SWCE/spring-cloud-zuul-ratelimit.svg?branch=master["Build Status", link="https://travis-ci.org/SWCE/spring-cloud-zuul-ratelimit"] image:https://sonarcloud.io/api/project_badges/measure?project=SWCE_spring-cloud-zuul-ratelimit&metric=alert_status["Quality Gate", link="https://sonarcloud.io/dashboard?id=SWCE_spring-cloud-zuul-ratelimit"] image:https://coveralls.io/repos/github/SWCE/spring-cloud-zuul-ratelimit/badge.svg?branch=master["Coverage Status", link="https://coveralls.io/github/SWCE/spring-cloud-zuul-ratelimit?branch=master"] image:https://api.bintray.com/packages/swce/spring-cloud-zuul-ratelimit/spring-cloud-zuul-ratelimit/images/download.svg[link="https://bintray.com/swce/spring-cloud-zuul-ratelimit/spring-cloud-zuul-ratelimit"]
:toc:
...
[NOTE]
====
Latest version: image:https://maven-badges.herokuapp.com/maven-central/SWCE/spring-cloud-zuul-ratelimit/badge.svg["Maven Central", link="https://maven-badges.herokuapp.com/maven-central/SWCE/spring-cloud-zuul-ratelimit"]
====
...
link:https://mvnrepository.com/artifact/com.github.swce/spring-cloud-zuul-ratelimit[Maven Central] and pick the
